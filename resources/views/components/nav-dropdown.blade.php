...
<div class="flex items-center md:order-2 space-x-1 md:space-x-0 rtl:space-x-reverse relative" x-data="{show: false}">
    <button @click="show = !show" type="button" data-dropdown-toggle="language-dropdown-menu"
