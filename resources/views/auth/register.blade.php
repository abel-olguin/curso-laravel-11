        ...
        <div
            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" action="{{ route('auth.register.store') }}" method="post">
                    ...
                    <x-forms.input :label="_('Email')" id="email" name="email" type="email" placeholder="Email"/>

                    <x-forms.input :label="_('Name')" id="name" name="name" placeholder="Ej. Pedro"/>

                    <x-forms.input :label="_('Last name')" id="last_name" name="last_name"
                                   placeholder="Ej. Perez Perez"/>

                    <x-forms.input :label="_('Password')" id="password" name="password" type="password"
                                   placeholder="••••••••"/>

                    <x-forms.input :label="_('Password confirmation')" id="password_confirmation"
